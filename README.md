...
The system employs a persistent in-memory dictionary that tracks:
 ...
 1. Conversation History: For context-aware responses.
  
  2. Intent Scores: To pivot between chat and lead capture.
  
  3. Entity Extraction: To remember your name or email across multiple turns.
